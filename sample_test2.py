...
for epoch in torch.arange(19,20):
 path = f'/scratch/private/eunbiyoon/Levy_motion-/CIFAR10noattch4clamp3.01.9_0.1_7.5/ckpt/CIFAR10noattch4clamp3.0_epoch{epoch}_1.9_0.1_7.5.pth'
 samples = sample(alpha_0=1.8,alpha_1=2,path='/home/eunbiyoon/combine/ckpt.pth',
                   beta_min=0.1, beta_max=20, sampler='pc_sampler2', batch_size=64, num_steps=1000, LM_steps=1000,
                   h=0.9,
                   Predictor=True, Corrector=False, trajectory=False, clamp=20, initial_clamp=100, clamp_mode="constant",
                   datasets="CIFAR10", name=str(epoch.item()), mode ='approximation',resolution=32, ch=128, ch_mult=[1, 2, 2,2], num_res_blocks=2,
                 dir_path='/home/eunbiyoon/combine')
