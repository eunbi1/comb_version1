...
def sample_fid(path='/home/eunbiyoon/comb_Levy_motion/approximationCIFAR10batch128lr0.0001ch128ch_mult[1, 2, 2, 2]num_res2dropout0.1clamp1001.8_0.1_20/ckpt/CIFAR10batch128ch128ch_mult[1, 2, 2, 2]num_res2dropout0.1clamp100_epoch1161_1.8_0.1_20.pth',
               image_folder='/home/eunbiyoon/comb_Levy_motion/18_cifar10',
               alpha=1.8, beta_min=0.1, beta_max=20,total_n_samples= 10000,
               num_steps=1000,
               channels=3,
               image_size=64, batch_size=64, device='cuda', datasets= 'CIFAR10',
        ...
        for _ in trange(n_rounds, desc="Generating image samples for FID evaluation."):
            ...
            if sampler =="ode_sampler":
             x = ode_sampler(score_model,
                ...
                device='cuda',
                clamp = 2.3,
                initial_clamp =100, final_clamp = 10,
...
def cifar102png(path='/home/eunbiyoon/comb_Levy_motion/cifar10'):
